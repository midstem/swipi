...
const esm = await import('@midstem/swipi-angular')
...
const cjs = require('@midstem/swipi-angular')
...
const manifest = require('@midstem/swipi-angular/package.json')
...
assert.deepEqual(
  ...
  ['@angular/core'],
  'the package asks for a peer other than @angular/core'
)
