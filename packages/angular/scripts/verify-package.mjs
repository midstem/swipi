...
const DECORATED = /__decorate|\u0275cmp|\u0275dir|\u0275fac|\u0275mod/

check(
  'the ESM bundle carries an Angular decorator, which needs an AOT-compiled package',
  !DECORATED.test(esm)
)

check(
  'the CJS bundle carries an Angular decorator, which needs an AOT-compiled package',
  !DECORATED.test(cjs)
)
