...
describe('useSwipiCarousel mounting', () => {
  it('drives the track it is handed through the ref', () => {
  ...
  it('hands the same reader to everyone who reads the signal', () => {
    const carousel = mountCarousel({ options: { slideWidth: 300 } })
  ...
  it('takes the element out of an ElementRef', () => {
    const carousel = mountCarousel({
      options: { slideWidth: 300 },
      asElementRef: true
    })
